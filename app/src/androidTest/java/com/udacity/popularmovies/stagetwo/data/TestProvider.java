...
//                LocationEntry.CONTENT_TYPE, type);
    ...
    public void testBasicWeatherQuery() {
        ...
        long movieRowId = TestUtilities.insertBatmanVSpidermanMovieValues(mContext);
...
//    }
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            movieValues.put(MovieContract.MovieEntry.COLUMN_VOTE_AVERAGE, "2.3");
            movieValues.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, "2016");
